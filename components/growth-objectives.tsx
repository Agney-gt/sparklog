...
import { BarChart3, HelpCircle, Plus, X } from "lucide-react"
  ...
  return (
    <div className="max-w-2xl mx-auto p-4 space-y-6">
      <div className="flex items-start gap-4">
        ...
        <div className="space-y-1">
          <h2 className="text-2xl font-bold tracking-tight">Growth Objectives</h2>
          <p className="text-muted-foreground">Set your growth objective and earn coins and EXP!</p>
        </div>
      </div>
